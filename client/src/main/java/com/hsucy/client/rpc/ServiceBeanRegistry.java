...
@Component
public class ServiceBeanRegistry implements BeanDefinitionRegistryPostProcessor, ResourceLoaderAware, ApplicationContextAware {
    ...
    public void postProcessBeanDefinitionRegistry(BeanDefinitionRegistry registry) throws BeansException {
        Set<Class<?>> clazzSet = scannerPackages("com.hsucy.client.remoteservice");
    ...
    public void setApplicationContext(ApplicationContext applicationContext) throws BeansException {
        ServiceBeanRegistry.applicationContext = applicationContext;
    }
}